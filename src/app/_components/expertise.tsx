  ...
  return (
    <div className="py-20">
      <h2 className="text-[28px] md:text-[38px] align-middle  items-center text-primary font-bold text-center">
        {" "}
        Savor a world of{" "}
        <span className="inline-flex md:hidden  px-4 translate-y-2 items-center justify-center">
          <Image
            className="md:w-[140px] w-[100px]"
            src={ExpertisePillImage1}
            alt=""
          />
        </span>{" "}
        flavors crafted by expert{" "}
        ...
        chefs, featuring fresh local ingredients and gourmet{" "}
        <br className="md:block hidden" />{" "}
        <span className="inline-flex items-center pr-4 justify-center translate-y-3">
          {" "}
          <Image
            className="md:w-[140px] w-[100px]"
            src={ExpertisePillImage2}
            alt=""
          />
        </span>{" "}
